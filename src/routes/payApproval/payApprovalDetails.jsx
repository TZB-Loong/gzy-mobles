...
class PayApprovalDetails extends Component {
  constructor(props) {
    super(props);
  ...
  withdrawPayment() {
    const { dispatch } = this.props;
    dispatch({
      type: "payApproval/withdrawPayment",
  ...
  render() {
    ...
    return (
      <ReactDocumentTitle title="支付审批">
        <div className={styles.payApprovalDetails}>
...
export default connect(({ payApproval }) => ({
  payApproval
}))(PayApprovalDetails, mapStateToProps);
